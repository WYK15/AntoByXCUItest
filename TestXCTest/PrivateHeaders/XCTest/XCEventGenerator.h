...
// iOS 10.3 specific
//- (double)forcePressAtPoint:(struct CGPoint)arg1 orientation:(long long)arg2 handler:(id)arg3;
...
//- (void)_startEventSequenceWithSteppingCallback:(id)arg1;
//- (void)_scheduleCallback:(id)arg1 afterInterval:(double)arg2;
- (id)init;
